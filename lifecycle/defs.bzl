"""Public API surface of rules_farakov_lifecycle.
...
load(
    ...
    _farakov_lifecycle_environments = "farakov_lifecycle_environments",
)
load(
...
load(
    ...
    _farakov_release_group = "farakov_release_group",
)
load(
